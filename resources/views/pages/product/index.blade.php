                ...
                <div class="single_product_thumb">
                    <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(img/product-img/phongkhach1.jpg);">
                            </li>
                            <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(img/product-img/phongkhach2.jpg);">
                            </li>
                            <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(img/product-img/phongkhach3.jpg);">
                            </li>
                            <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(img/product-img/phongkhach4.jpg);">
                            </li>
                        </ol>

                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a class="gallery_img" href="img/product-img/phongkhach1.jpg">
                                    <img class="d-block w-100" src="img/product-img/phongkhach1.jpg" alt="First slide">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="gallery_img" href="img/product-img/phongkhach2.jpg">
                                    <img class="d-block w-100" src="img/product-img/phongkhach2.jpg" alt="Second slide">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="gallery_img" href="img/product-img/phongkhach3.jpg">
                                    <img class="d-block w-100" src="img/product-img/phongkhach3.jpg" alt="Third slide">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a class="gallery_img" href="img/product-img/phongkhach4.jpg">
                                    <img class="d-block w-100" src="img/product-img/phongkhach4.jpg" alt="Fourth slide">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single_product_desc">
                    ...
                    <div class="widget size mb-30">
                        ...
                        <div class="widget-desc">
                            <ul>
                                <li data-target="#product_details_slider" data-slide-to="0"><a >Ghi</a></li>
                                <li data-target="#product_details_slider" data-slide-to="1"><a >Xám</a></li>
                                <li data-target="#product_details_slider" data-slide-to="2"><a >Trắng sữa</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="widget size mb-30">
                        ...
                        <div class="widget-desc">
                            <ul>
                                <li><a href="">100 m2</a></li>
                                <li><a href="#">200 m2</a></li>
                                <li><a href="#">300 m2</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <form class="cart clearfix mb-50 d-flex" method="post">
                        ...
                        <button type="submit" name="addtocart" value="5" class="btn cart-submit d-block">Thêm vào rỏ hàng</button>
                    </form>
            ...
            <div class="col-12">
                <div class="you_make_like_slider owl-carousel">
                    ...
                    <div class="single_gallery_item">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="img/product-img/phongkhach4.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
